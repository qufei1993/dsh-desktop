...
- Keep the untrusted-certificate disclosure and checksum verification instructions visible in the README and Release notes.
...
- Test the ad-hoc-signed macOS Gatekeeper path and unsigned Windows SmartScreen path on clean machines.
