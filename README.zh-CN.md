...
发现安全问题时，请按[安全策略](SECURITY.zh-CN.md)私下报告，不要创建公开 Issue。
...
`verify` 包含类型检查、自动测试、生产构建和产品边界审计。完整开发流程与变更要求见[贡献指南](CONTRIBUTING.zh-CN.md)。
...
更完整的边界、进程模型和数据约束见[设计说明](docs/superpowers/specs/2026-08-15-dsh-desktop-design.md)。项目维护方式、支持范围和版本变化分别记录在[维护者说明](MAINTAINERS.zh-CN.md)、[支持指南](SUPPORT.zh-CN.md)与[变更日志](CHANGELOG.zh-CN.md)中。

准备维护或发布仓库时，请继续阅读[发布指南](docs/RELEASING.zh-CN.md)和[GitHub 仓库上线清单](docs/REPOSITORY_SETUP.zh-CN.md)。
