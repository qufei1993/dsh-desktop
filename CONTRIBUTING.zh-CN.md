...
参与项目即表示你同意遵守[行为准则](CODE_OF_CONDUCT.zh-CN.md)。安全漏洞请按[安全策略](SECURITY.zh-CN.md)私下报告，不要提交公开 Issue。
...
- 不混入无关格式化或重构。
- 如有用户可见变化，在 `CHANGELOG.zh-CN.md` 的“未发布”部分记录，并同步更新英文 `CHANGELOG.md`。
